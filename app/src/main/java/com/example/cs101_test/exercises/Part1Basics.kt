...
object Part1Basics {
    ...
    fun findMax(numbers: List<Int>): Int {
        // Your code here
        return numbers.maxOrNull()!! //kan ikke få det til at virke (fik hjælp med chat til !!)
    }
    ...
    fun getValue(map: Map<String, Int>, key: String): Int? {
        // Your code here
        return map[key] //lidt hjælp af chat
    }
    ...
    fun charFrequency(str: String): Map<Char, Int> {
        // Your code here
        return str
            .filter { it.isLetter() }.groupingBy { it }.eachCount() //Fik meget hjælp fra chat
    }
}
